...
def app():
    ...
    sortie = st.selectbox("Axe des ordonnées", ['cash_flow_actu', 'tri', "cumul_cash_flow_actu","cout_exploitation_tonne_minerai","teneur_minerai_industriel","tonnage_industriel","qte_or_paye","recette_tonne_minerai","dep_operatoiresMCO","dep_operatoiresTraitement","dep_operatoiresTotale","recette","taux_actualisation_"], )
    inputt = st.selectbox("Axe des abcisses",['annee'])
